...
namespace Modules\Logs\Tests\Unit\Controllers;

use Illuminate\Http\Response;
use Modules\Logs\Entities\Log;
use Tests\TestCase;

class LogsRestControllerTest extends TestCase
{
    public function testIndex() : void
    {
        ...
        // when
        $result = $this->get('/logs/rest/find-all');
    ...
    public function testCreateLog() : void
    {
        ...
        // when
        $result = $this->post('/logs/rest/store', $log);
